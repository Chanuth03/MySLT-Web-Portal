...
import { FaGift, FaMobile, FaPhone, FaTv, FaWifi } from "react-icons/fa";
...
const CustomNavBar = () => {
  ...
  if (selectedTelephone === "0714329988") {
    disabledItems = ["PeoTV", "Voice", "Broadband", "Promotions"];
  } else if (isPrepaid) {
    disabledItems = ["PeoTV", "Mobile", "Voice"];
  }
  ...
  useEffect(() => {
    if (selectedTelephone === "0714329988") {
      setSelectedNavbarItem("Mobile");
      setSelectedItem("Mobile");
    } else {
