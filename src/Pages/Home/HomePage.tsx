...
const HomePage: React.FC = () => {
  ...
  const [platformAnimationCompleted, setPlatformAnimationCompleted] =
  ...
  useEffect(() => {
    ...
    const platformTimer = setTimeout(
      () => setPlatformAnimationCompleted(true),
      2000
    );
  ...
  return (
    <div className="homepage-container">
      <nav
        className={`main-nav ${
          platformAnimationCompleted ? "fade-in-element" : "hidden-element"
        }`}
      >
        ...
        <nav className="navigation-container">
          <div
            className={`nav-center ${mobileMenuOpen ? "mobile-nav-open" : ""}`}
          >
      ...
      <div className={`main-content`}>
        ...
        <div
          className={`marketing-message top-message ${
            platformAnimationCompleted ? "fade-in-element" : "hidden-element"
          }`}
        >
        ...
        <div
          className={`marketing-message bottom-message ${
            platformAnimationCompleted ? "fade-in-element" : "hidden-element"
          }`}
        >
        ...
        <div
          className={`fiber-mascot ${
            animationCompleted ? "animate-mascot" : ""
          }`}
        >
          <img
            src="src/assets/fiber-mascot.png"
            alt="FibreOn Mascot"
            className="mascot-image"
          />
          <img
            src="src/assets/platform-circle.png"
            alt="Platform"
            className={`mascot-platform ${
              animationCompleted ? "animate-platform" : ""
            }`}
          />
        </div>
